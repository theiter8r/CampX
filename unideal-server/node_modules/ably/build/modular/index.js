...
function inspectError(err) {
  ...
  if (
    ...
    ((_a2 = err == null ? void 0 : err.constructor) == null ? void 0 : _a2.name) === 'ErrorInfo' ||
    ((_b = err == null ? void 0 : err.constructor) == null ? void 0 : _b.name) === 'PartialErrorInfo'
  )
    return err.toString();
...
function objectifyOptions(options, requireObject, sourceForErrorMessage, modularPluginsToInclude) {
  if (options === void 0) {
    const msg = requireObject
...
function defaultGetHeaders(
  options,
  { format = defaultHeadersOptions.format, protocolVersion = defaultHeadersOptions.protocolVersion } = {},
) {
...
var Auth = class {
  ...
  async authorize(tokenParams, authOptions) {
    ...
    try {
      let tokenDetails = await this._forceNewToken(
        tokenParams != null ? tokenParams : null,
        authOptions != null ? authOptions : null,
      );
      if (isRealtime(this.client)) {
        return new Promise((resolve, reject) => {
          this.client.connection.connectionManager.onAuthUpdated(tokenDetails, (err, tokenDetails2) =>
            err ? reject(err) : resolve(tokenDetails2),
          );
        });
      } else {
        return tokenDetails;
  ...
  async requestToken(tokenParams, authOptions) {
    ...
    if (resolvedAuthOptions.authCallback) {
      ...
      tokenRequestCallback = (params, cb) => {
        whenPromiseSettles(this.createTokenRequest(params, resolvedAuthOptions), (err, result) =>
          cb(err, result != null ? result : null),
        );
      };
    } else {
      const msg =
  ...
  async _ensureValidAuthCredentials(forceSupersede) {
    ...
    const promise = (
      this.waitingForTokenRequest || (this.waitingForTokenRequest = multicaster_default.create())
    ).createPromise();
...
var BaseClient = class {
  constructor(options) {
    ...
    this.__FilteredSubscriptions =
      (_h = (_g = options.plugins) == null ? void 0 : _g.MessageInteractions) != null ? _h : null;
  }
  get rest() {
    if (!this._rest) {
...
var Resource = class _Resource {
  static async get(client, path, headers, params, envelope, throwError) {
    return _Resource.do(
      ...
      params,
      envelope,
      throwError != null ? throwError : false,
    );
  }
...
var PaginatedResource = class {
  ...
  async post(params, body) {
    const result = await resource_default.post(
      this.client,
      this.path,
      body,
      this.headers,
  ...
  async patch(params, body) {
    const result = await resource_default.patch(
      this.client,
      this.path,
      body,
      this.headers,
  ...
  async handlePage(result) {
    ...
    try {
      items =
        result.statusCode == HttpStatusCodes_default.NoContent
          ? []
...
var DeviceRegistrations = class {
  ...
  async list(params) {
    ...
    mixin(headers, client.options.headers);
    return new paginatedresource_default(client, '/push/deviceRegistrations', headers, envelope, async function (
      body,
      headers2,
      unpacked,
    ) {
...
var ChannelSubscriptions = class _ChannelSubscriptions {
  ...
  async list(params) {
    ...
    mixin(headers, client.options.headers);
    return new paginatedresource_default(client, '/push/channelSubscriptions', headers, envelope, async function (
      body,
      headers2,
      unpacked,
    ) {
  ...
  async listChannels(params) {
    ...
    return new paginatedresource_default(client, '/push/channels', headers, envelope, async function (
      body,
      headers2,
      unpacked,
    ) {
...
async function encode(msg, options) {
  ...
  const nativeDataType =
    typeof data == 'string' || Platform.BufferUtils.isBuffer(data) || data === null || data === void 0;
  if (!nativeDataType) {
...
var RestChannelMixin = class {
  ...
  static history(channel, params) {
    ...
    return new paginatedresource_default(
      client,
      this.basePath(channel) + '/messages',
      headers,
      envelope,
      async function (body, headers2, unpacked) {
...
var Rest = class {
  ...
  async request(method, path, version2, params, body, customHeaders) {
    ...
    const headers =
      _method == 'get'
        ? defaults_default.defaultGetHeaders(this.client.options, {
            format,
...
var BaseRest = class extends baseclient_default {
  // The public typings declare that this only accepts an object, but since we want to emit a good error message in the case where a non-TypeScript user passes a string (which is quite likely if they’re e.g. migrating from the default variant to the modular variant), tell the compiler that it might receive a string so that the compiler forces us to handle the case where a string is passed.
  constructor(options) {
    super(
      defaults_default.objectifyOptions(options, true, 'BaseRest', {
        Rest,
      }),
    );
  }
...
function fromDeserialized(deserialized, presenceMessagePlugin) {
  ...
  return Object.assign(
    new ProtocolMessage(),
    __spreadProps(__spreadValues({}, deserialized), {
      presence,
    }),
  );
}
  ...
  send(pendingMessage) {
    ...
    if (logger_default.shouldLog(logger_default.LOG_MICRO)) {
      logger_default.logActionNoStrip(
        ...
        'Protocol.send()',
        'sending msg; ' +
          stringify(pendingMessage.message, this.transport.connectionManager.realtime._RealtimePresence),
      );
    }
    ...
    if (logger_default.shouldLog(logger_default.LOG_MICRO)) {
      logger_default.logActionNoStrip(
        ...
        'received on ' +
          this.shortName +
          ': ' +
          stringify(message, this.connectionManager.realtime._RealtimePresence) +
          '; connectionId = ' +
...
var haveWebStorage = () => {
  var _a2;
  return (
    typeof Platform.WebStorage !== 'undefined' && ((_a2 = Platform.WebStorage) == null ? void 0 : _a2.localSupported)
  );
};
var haveSessionStorage = () => {
  var _a2;
  return (
    typeof Platform.WebStorage !== 'undefined' && ((_a2 = Platform.WebStorage) == null ? void 0 : _a2.sessionSupported)
  );
};
var noop = function () {};
...
function getSessionRecoverData() {
  ...
  return (
    haveSessionStorage() &&
    ((_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.getSession) == null
      ? void 0
      : _b.call(_a2, sessionRecoveryName))
  );
}
function setSessionRecoverData(value) {
  ...
  return (
    haveSessionStorage() &&
    ((_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.setSession) == null
      ? void 0
      : _b.call(_a2, sessionRecoveryName, value))
  );
}
function clearSessionRecoverData() {
  ...
  return (
    haveSessionStorage() &&
    ((_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.removeSession) == null
      ? void 0
      : _b.call(_a2, sessionRecoveryName))
  );
}
...
var ConnectionManager = class _ConnectionManager extends eventemitter_default {
  ...
  static initTransports(additionalImplementations, storage) {
    const implementations = __spreadValues(
      __spreadValues({}, Platform.Transports.bundledImplementations),
  ...
  tryATransport(transportParams, candidate, callback) {
    transport_default.tryConnect(
      ...
      (wrappedErr, transport) => {
        ...
        if (wrappedErr) {
          if (
            auth_default.isTokenErr(wrappedErr.error) &&
            !(this.errorReason && auth_default.isTokenErr(this.errorReason))
          ) {
  ...
  deactivateTransport(transport, state, error) {
    const currentProtocol = this.activeProtocol,
      ...
      wasPending = arrDeleteValue(this.pendingTransports, transport),
      wasProposed = arrDeleteValue(this.proposedTransports, transport),
  ...
  noTransportsScheduledForActivation() {
    return (
      isEmpty(this.pendingTransports) ||
    ...
    const retryImmediately =
      ...
      (this.state === this.states.connected ||
        ...
        (this.state === this.states.connecting &&
          indicated.error &&
          auth_default.isTokenErr(indicated.error) &&
          !(this.errorReason && auth_default.isTokenErr(this.errorReason))));
  ...
  requestState(request) {
    ...
    const newState = this.states[state],
      change = new connectionstatechange_default(
        this.state.state,
        newState.state,
        null,
  ...
  getTransportPreference() {
    ...
    return (
      ...
      (haveWebStorage() &&
        ((_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.get) == null
          ? void 0
          : _b.call(_a2, transportPreferenceName)))
    );
  }
  persistTransportPreference(transport) {
    ...
    if (defaults_default.upgradeTransports.includes(transport.shortName)) {
      ...
      if (haveWebStorage()) {
        (_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.set) == null
          ? void 0
          : _b.call(_a2, transportPreferenceName, transport.shortName);
      }
    }
  }
  unpersistTransportPreference() {
    ...
    this.transportPreference = null;
    if (haveWebStorage()) {
      (_b = (_a2 = Platform.WebStorage) == null ? void 0 : _a2.remove) == null
        ? void 0
        : _b.call(_a2, transportPreferenceName);
    }
  }
...
var RealtimeChannel = class _RealtimeChannel extends eventemitter_default {
  ...
  async publish(...args) {
    ...
    if (argCount == 1) {
      if (isObject(messages)) messages = [fromValues(messages)];
      else if (Array.isArray(messages)) messages = fromValuesArray(messages);
      else
        throw new ErrorInfo(
          'The single-argument form of publish() expects a message object or an array of message objects',
          40013,
          ...
          callback == null
            ...
            : callback(
                stateChange.reason ||
                  ...
                  new ErrorInfo('Unable to attach; reason unknown; state = ' + this.event, 9e4, 500),
              );
          break;
        case 'detaching':
          callback == null
            ...
            switch (this.event) {
              ...
              case 'failed':
                reject(
                  stateChange.reason ||
                    connectionManager.getError() ||
                    new ErrorInfo('Unable to detach; reason unknown; state = ' + this.event, 9e4, 500),
                );
                break;
              case 'attaching':
  ...
  unsubscribe(...args) {
    ...
    if (
      ...
      ((_a2 = this.filteredSubscriptions) == null ? void 0 : _a2.has(listener))
    ) {
  ...
  async processMessage(message) {
    if (
      message.action === actions2.ATTACHED ||
      message.action === actions2.MESSAGE ||
      message.action === actions2.PRESENCE
    ) {
...
var BaseRealtime = class _BaseRealtime extends baseclient_default {
  ...
  constructor(options) {
    var _a2, _b;
    super(defaults_default.objectifyOptions(options, true, 'BaseRealtime'));
    ...
    this._RealtimePresence =
      (_b = (_a2 = this.options.plugins) == null ? void 0 : _a2.RealtimePresence) != null ? _b : null;
  ...
  static transportImplementationsFromPlugins(plugins) {
    ...
    if (plugins == null ? void 0 : plugins.XHRStreaming) {
...
var Http2 =
  ((_a = class {
    constructor(client) {
      ...
      const connectivityCheckUrl =
        (client == null ? void 0 : client.options.connectivityCheckUrl) || defaults_default.connectivityCheckUrl;
      const connectivityCheckParams =
        (_a2 = client == null ? void 0 : client.options.connectivityCheckParams) != null ? _a2 : null;
      const connectivityUrlIsDefault = !(client == null ? void 0 : client.options.connectivityCheckUrl);
      const requestImplementations = __spreadValues(
        __spreadValues({}, Http2.bundledRequestImplementations),
        client == null ? void 0 : client._additionalHTTPRequestImplementations,
      );
      ...
      if (Platform.Config.xhrSupported && xhrRequestImplementation) {
        ...
        this.Request = async function (method, uri, headers, params, body) {
          return new Promise((resolve) => {
            ...
            req.once('complete', (error, body2, headers2, unpacked, statusCode) =>
              resolve({
                error,
                body: body2,
                headers: headers2,
        ...
        if (client == null ? void 0 : client.options.disableConnectivityCheck) {
          ...
          this.checkConnectivity = async function () {
            ...
            if (!connectivityUrlIsDefault) {
              ...
              result =
                !requestResult.error && ((_a3 = requestResult.body) == null ? void 0 : _a3.replace(/\n/, '')) == 'yes';
            }
            return result;
          };
        }
  ...
  (_a.methodsWithoutBody = [HttpMethods_default.Get, HttpMethods_default.Delete]),
  (_a.methodsWithBody = [HttpMethods_default.Post, HttpMethods_default.Put, HttpMethods_default.Patch]),
  _a);
...
var Config = {
  ...
  nextTick:
    typeof globalObject3.setImmediate !== 'undefined'
      ? globalObject3.setImmediate.bind(globalObject3)
      : function (f) {
          setTimeout(f, 0);
        },
...
var XHRRequest = class _XHRRequest extends eventemitter_default {
  ...
  exec() {
    ...
    const timeout =
        this.requestMode == XHRStates_default.REQ_SEND ? this.timeouts.httpRequestTimeout : this.timeouts.recvTimeout,
...
function initialiseTransport2(transportStorage) {
  if (XHRStreamingTransport.isAvailable()) transportStorage.supportedTransports[shortName2] = XHRStreamingTransport;
...
function initialiseTransport3(transportStorage) {
  if (WebSocketTransport.isAvailable()) transportStorage.supportedTransports[shortName3] = WebSocketTransport;
...
async function fetchRequest(method, client, uri, headers, params, body) {
  ...
  const resultPromise = (async () => {
    try {
      ...
      if (!res.ok) {
        const error =
          getAblyError2(body2, res.headers) ||
    ...
    const myMembers = this._myMembers,
      reenterCb = (err) => {
        if (err) {
          ...
          const change = new channelstatechange_default(
            this.channel.state,
            this.channel.state,
            true,
            false,
...
var FilteredSubscriptions = class {
  ...
  static addFilteredSubscription(channel, filter, realListener, filteredListener) {
    ...
    if (channel.filteredSubscriptions.has(realListener)) {
      ...
      realListenerMap.set(
        filter,
        ((_a2 = realListenerMap == null ? void 0 : realListenerMap.get(filter)) == null
          ? void 0
          : _a2.concat(filteredListener)) || [filteredListener],
      );
    } else {
